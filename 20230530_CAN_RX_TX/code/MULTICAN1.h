...
#include "IfxMultican.h"                      /* contains the general CAN module configuration and utility functions */
...
#define STB                         &MODULE_P20,6               /* Set STB Pin number->refer to pin 6 of MODULE_P20  */
