...
#define encoder1                   &MODULE_P02,1            /* Pin that is toggled by pressing the board's button   */
#define encoder2                   &MODULE_P02,0            /* LED which gets toggled in Interrupt Service Routine  */
#define PI                         3.141592
