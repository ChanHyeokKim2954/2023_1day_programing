...
void timer()
{
 ...
 // PID for position control
  ...
  else if(motor_mode == 'v')  pos_pid_control();
...
void loop()
{
  ...
  if (Serial.available() > 0) 
  {
    ...
    else if(control_mode == 'p')
    {
      ...
      if(motor_direction =='r')       target_Pos = -data;
      else if(motor_direction == 'f')       target_Pos = data;
    ...
    else if(control_mode == 'v')
    {
      ...
      v = String(data_buffer);
      data = v.toInt();

      if(motor_direction =='r')       pos_vel = -data;
      else if(motor_direction == 'f')       pos_vel = data;

      Serial.print("pos_vel : ");      
      Serial.println(pos_vel);
      Serial.println("");
      motor_flag = 1;
    }
  }
