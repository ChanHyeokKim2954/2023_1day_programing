...
uint32 map_value = 0;
uint32 map(int, int, int, int, int);
/*********************************************************************************************************************/
...
uint32 map(int x, int in_min, int in_max, int out_min, int out_max)
{
...
int indicateConversionValue(void)
{
    ...
    adc_value = conversionResult.B.RESULT; //ADC Data

    map_value = map(adc_value,0,4095,0,255);
