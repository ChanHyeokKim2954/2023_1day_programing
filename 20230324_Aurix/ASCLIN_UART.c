...
void send_ADC(int data)
{
    ...
    ADC_test[2] = 'i';
    ADC_test[3] = 1;
    ADC_test[4] = (uint8)data;

    crc_16_val_S.check_sum = CRC16_MODBUS(ADC_test, 5);

    ADC_test[5] = crc_16_val_S.b[0];
    ADC_test[6] = crc_16_val_S.b[1];

    IfxAsclin_Asc_write(&g_ascHandle, ADC_test, &a_count, TIME_INFINITE);  /* Transmit data via TX */
}
...
void OUTPUT_GUI(void)
{


    (uart_rx_buff[0] != 0) ?  IfxPort_setPinHigh(LED1) : IfxPort_setPinLow(LED1);
    (uart_rx_buff[1] != 0) ?  IfxPort_setPinHigh(LED2) : IfxPort_setPinLow(LED2);
    (uart_rx_buff[2] != 0) ?  IfxPort_setPinHigh(LED3) : IfxPort_setPinLow(LED3);
    (uart_rx_buff[3] != 0) ?  IfxPort_setPinHigh(LED4) : IfxPort_setPinLow(LED4);
    (uart_rx_buff[4] != 0) ?  IfxPort_setPinHigh(LED5) : IfxPort_setPinLow(LED5);
    (uart_rx_buff[5] != 0) ?  IfxPort_setPinHigh(LED6) : IfxPort_setPinLow(LED6);
    (uart_rx_buff[6] != 0) ?  IfxPort_setPinHigh(LED7) : IfxPort_setPinLow(LED7);
    (uart_rx_buff[7] != 0) ?  IfxPort_setPinHigh(LED8) : IfxPort_setPinLow(LED8);
