...
void TF_base_link_base_link_map(Point2D base_link_point2d)
{
...
void TF_base_link_map_base_link(Point2D* base_link_map_point2d)
{
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	TF_base_link_map_base_link(&base_link_map_Point2D);
